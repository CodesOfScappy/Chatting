...
import com.codeofscappy.myapplication.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Button [SignUp] Listener to Click
        ...
        binding.txtAlreadyHveAccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
